...
export default class MultiSelect extends Component {
  ...
  static defaultProps = {
    ...
    onAddItem: () => {},
    style:{},
    dropdownViewClosedStyles:{},
    dropdownViewOpenStyles:{},
    submitButtonStyles:{}
    ...
    return (
      ...
      >
        {selector ? (
          <View style={styles.selectorView(fixedHeight)}>
            ...
            <View
              style={[{
                flexDirection: 'column',
                backgroundColor: '#fff',
              }, styles.dropDownView(fixedHeight), this.props.dropdownViewOpenStyles]}
            >
          ...
          <View>
            <View style={[styles.dropdownView,  this.props.dropdownViewClosedStyles]}>
              <View
                style={[
                  styles.subSection,
