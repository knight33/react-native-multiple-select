    ...
    return (
      ...
      >
        {selector ? (
          <View style={styles.selectorView(fixedHeight)}>
            ...
            <View
              style={[{
                flexDirection: 'column',
                backgroundColor: '#fff',
              }, styles.dropDownView(fixedHeight), this.props.dropdownViewStyles]}
            >
          ...
          <View>
            <View style={[styles.dropdownView, styles.dropDownView(fixedHeight), this.props.dropdownViewStyles]}>
              <View
                style={[
                  styles.subSection,
